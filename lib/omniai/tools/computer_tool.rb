  ...
  module Tools
    ...
    class ComputerTool < OmniAI::Tool
      ...
      module Action
        ...
        MOUSE_TRIPPLE_CLICK = "mouse_triple_click" # triple click at a specific x / y coordinate
        TYPE = "type" # type a string
        SCROLL = "scroll"
        WAIT = "wait"
        SCREENSHOT = "screenshot"
        DISPLAY_BOUNDS = "display_bounds" # get the display bounds
      end
      ...
      parameter :action, :string, enum: ACTIONS, description: <<~TEXT
        ...
        * `#{Action::MOUSE_TRIPPLE_CLICK}`: Triple click at the specified (x,y) pixel coordinate on the screen.
        ...
        * `#{Action::SCREENSHOT}`: Take a screenshot of the screen.
        * `#{Action::DISPLAY_BOUNDS}`: Get the width / height of the screen.
      TEXT
      ...
      def execute(
        ...
        @logger.info({
          ...
          scroll_direction:,
          scroll_amount:,
        }.compact.map { |k, v| "#{k}=#{v.inspect}" }.join(" "))
        ...
        when Action::MOUSE_TRIPPLE_CLICK then @driver.mouse_triple_click(coordinate:, button: mouse_button)
        ...
        when Action::SCREENSHOT then @driver.screenshot
        when Action::DISPLAY_BOUNDS then @driver.display_bounds
        end
      end
    end
  end
